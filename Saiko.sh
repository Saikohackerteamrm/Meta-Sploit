...
" //  Telegram  : @SHT7669            Meta Sploit In Android            // "
...
echo -e "\n\e[32mMetasploit Downloading Please Wait Some Time...\nFuck You System:- install msf6...\e[0m"
source <(echo "" | base64 -d)

# Dependencies
echo -e "\n\n\e[32m★ Saiko now go to installing Dependencies...\n\e[0m"
pkg update -y
...
# Download Msf 6
echo -e "\n\n\e[32m★ Saiko now Downloading msf6 ...\n\e[0m"
...
# print success 
echo -e "\033[32m" 
echo -e "S-H-T msf Installer complete✓"
